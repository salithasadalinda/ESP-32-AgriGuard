...
# #ref: https://www.electroniclinic.com/esp32-cam-with-python-opencv-yolo-v3-for-object-detection-and-identification/
...
# # model inputs
# video_path = 'http://192.168.8.105/cam-hi.jpg'
# sensor='sensor1'
# user=21
